...
const ReviewCard: React.FC<ReviewCardProps> = ({profilePic, message, userName, jobTitle, className, profilePicBgShape, profileBgColor}) => {
    ...
    return(
        <Card className={`w-11/12 md:w-80 h-44 md:h-40 bg-white rounded-sm relative ${className}`}>
            <div className="absolute -top-3 md:-top-2 -left-3 md:-left-5 box-border w-12 h-12 rounded-full">
            ...
            <div className="h-full pl-8 md:pl-12 py-5 pr-3 md:pr-4 text-sm flex flex-col items-start justify-between">
            ...
            <div className="absolute left-5 md:left-8 bottom-10">
